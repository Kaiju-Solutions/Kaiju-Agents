...
- Integrations with [Unity Behavior](https://docs.unity3d.com/Packages/com.unity.behavior@latest "Unity Behavior"), [Unity ML-Agents](https://docs.unity3d.com/Packages/com.unity.ml-agents@latest "Unity ML-Agents"), and [Coplay](https://www.coplay.dev "Coplay")'s [Unity MCP](https://github.com/CoplayDev/unity-mcp "Unity MCP").
...
[![Unity Behavior Integration](https://agents.kaijusolutions.ca/img/behavior.png)](https://agents.kaijusolutions.ca/manual/behavior-graph.html "Unity Behavior Integration")

[Integration](https://agents.kaijusolutions.ca/manual/behavior-graph.html "Unity Behavior Integration") with [Unity Behavior](https://docs.unity3d.com/Packages/com.unity.behavior@latest "Unity Behavior")
