...
{
    /// <summary>
    /// Have any generic <see cref="KaijuSolutions.Agents.Actuators.KaijuActuator"/> work with <see href="https://docs.unity3d.com/Packages/com.unity.ml-agents@latest">ML-Agents</see>. This has three discrete actions, being to do nothing, run the <see cref="KaijuSolutions.Agents.Actuators.KaijuActuator"/>, or cancel running it. These actions are masked accordingly. This has no <see cref="Heuristic"/> implementation, and you will need to extend this class and override for your use case.
    /// </summary>
...
#endif
    public class KaijuLearningActuator : KaijuLearningActuatorBase
    {
        /// <summary>
...
#endif
        [SerializeField]
        private KaijuActuator actuator;
#if UNITY_EDITOR
        /// <summary>
        ...
        private void OnValidate()
        {
            ...
            {
                actuator = GetComponent<KaijuActuator>();
            }
        }
#endif
        /// <summary>
        ...
        {
            // Can call to run if not running, and call to stop only when running.
            bool running = actuator.IsRunning;
            actionMask.SetActionEnabled(0, 0, true);
            actionMask.SetActionEnabled(0, 1, !running);
