...
namespace KaijuSolutions.Agents
{
    ...
    public sealed class KaijuCharacterAgent : KaijuAgent
    {
        ...
        {
            return $"{name} - Kaiju Character Agent - {(isActiveAndEnabled ? "Active" : "Inactive")} - Velocity: {Velocity} - Move Speed: {MoveSpeed} - Move Acceleration: {MoveAcceleration} - Look Speed: {LookSpeed}";
        }
