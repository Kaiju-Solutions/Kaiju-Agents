...
{
    /// <summary>
    /// An <see cref="KaijuSolutions.Agents.KaijuAgent"/> type which tries to get its radius from colliders or otherwise manually assigns them.
    /// </summary>
    ...
    {
        /// <summary>
        /// The radius of this <see cref="KaijuSolutions.Agents.KaijuAgent"/>. If there is an attached collider, this will lock to it and calculate the radius based on its size and cannot be set.
        /// </summary>
        public float Radius
        {
            get => radius;
        ...
        {
            return $"{name} - Kaiju Radius Agent - {(isActiveAndEnabled ? "Active" : "Inactive")} - Velocity: {Velocity} - Move Speed: {MoveSpeed} - Move Acceleration: {MoveAcceleration} - Look Speed: {LookSpeed} - Radius: {Radius}";
        }
        ...
        /// <returns>The <see cref="KaijuSolutions.Agents.KaijuAgent"/> attached to the <see href="https://docs.unity3d.com/Manual/class-GameObject.html">GameObject</see> if there was one.</returns>
        ...
        /// <returns>The <see cref="KaijuSolutions.Agents.KaijuAgent"/> attached to the <see href="https://docs.unity3d.com/Manual/class-transform.html">transform</see> if there was one.</returns>
