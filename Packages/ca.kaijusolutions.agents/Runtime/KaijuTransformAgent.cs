...
namespace KaijuSolutions.Agents
{
    ...
    public sealed class KaijuTransformAgent : KaijuRadiusAgent
    {
        ...
        {
            return $"{name} - Kaiju Transform Agent - {(isActiveAndEnabled ? "Active" : "Inactive")} - Velocity: {Velocity} - Move Speed: {MoveSpeed} - Move Acceleration: {MoveAcceleration} - Look Speed: {LookSpeed} - Radius: {Radius}";
        }
