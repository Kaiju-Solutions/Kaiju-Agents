...
{
    /// <summary>
    /// Base <see cref="KaijuSolutions.Agents.Movement.KaijuMovement"/> class for moving towards a single target.
    /// </summary>
    public abstract class KaijuApproachingMovement : KaijuTargetMovement
    {
        /// <summary>
        /// The default <see cref="KaijuSolutions.Agents.Movement.KaijuTargetMovement.Distance"/> of <see cref="KaijuSolutions.Agents.Movement.KaijuApproachingMovement"/>s and <see cref="KaijuSolutions.Agents.Movement.KaijuPathFollowMovement"/>s.
        /// </summary>
