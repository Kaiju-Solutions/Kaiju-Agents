...
namespace KaijuSolutions.Agents.Movement
{
    ...
    public class KaijuFleeMovement : KaijuLeavingMovement
    {
        ...
        /// <returns>Get a <see cref="KaijuSolutions.Agents.Movement.KaijuWanderMovement"/> for the <see cref="KaijuSolutions.Agents.KaijuAgent"/>.</returns>
        ...
        /// <param name="distance">At what distance from the target should the flee be considered successful.</param>
        /// <param name="weight">The weight of this <see cref="KaijuSolutions.Agents.Movement.KaijuMovement"/>.</param>
        /// <returns>Get a flee movement for the <see cref="KaijuSolutions.Agents.KaijuAgent"/>.</returns>
        ...
        {
            return $"Kaiju Flee Movement - Agent: {(Agent ? Agent : "None")} - Target: {Target.ToString()} - Distance: {Distance} - Current Distance: {CurrentDistance} - Weight: {Weight} - {(Done() ? "Done" : "Executing")}";
        }
    }
}