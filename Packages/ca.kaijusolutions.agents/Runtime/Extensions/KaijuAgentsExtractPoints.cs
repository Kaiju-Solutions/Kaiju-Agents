...
namespace KaijuSolutions.Agents.Extensions
{
    ...
    {
        /// <summary>
        /// Extract the point vectors from hits. This does not perform any actual casting. For casting, see <see cref="KaijuAgentsArcRaycast"/> and <see cref="KaijuAgentsArcSphereCast"/>. This can be useful if your <see cref="KaijuSolutions.Agents.KaijuAgent"/> only needs position vectors or to help perform debugging.
        /// </summary>
