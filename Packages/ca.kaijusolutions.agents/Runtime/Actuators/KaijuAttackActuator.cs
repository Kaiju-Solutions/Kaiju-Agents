...
namespace KaijuSolutions.Agents.Actuators
{
    ...
    [HelpURL("https://agents.kaijusolutions.ca/manual/actuators.html#attack-actuator")]
#endif
    public abstract class KaijuAttackActuator: KaijuActuator
    {
        ...
        {
            return $"{name} - Kaiju Attack Actuator - Agent: {(Agent ? Agent : "None")} - Range: {Range} - Charge: {Charge} - Cooldown: {Cooldown}";
        }
