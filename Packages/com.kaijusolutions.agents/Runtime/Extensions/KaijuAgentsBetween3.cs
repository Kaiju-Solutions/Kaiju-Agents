...
{
    /// <summary>
    /// Extension methods to see if points are between two given distances of each other along all three axes. These methods are inclusive of the distances to check. Any <see href="https://docs.unity3d.com/ScriptReference/Vector2.html">Vector2</see> values will be expanded via the <see cref="KaijuAgentsExpand.Expand"/> method.
    /// </summary>
