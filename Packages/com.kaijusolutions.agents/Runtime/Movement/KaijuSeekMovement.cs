...
namespace KaijuSolutions.Agents.Movement
{
    ...
    public class KaijuSeekMovement : KaijuApproachingMovement
    {
        ...
        /// </summary>
        /// <param name="agent">The agent this is assigned to.</param>
        /// <param name="target">The <see href="https://docs.unity3d.com/ScriptReference/Transform.html">transform</see> to seek to.</param>
        /// <param name="distance">The distance from the target to consider this movement done.</param>
        ...
        {
            Vector2? t = Target;
            return $"Kaiju Seek Movement - Agent: {(Agent ? Agent.name : "None")} - Target: {(t.HasValue ? t.ToString() : "None")} - Distance: {Distance} - Current Distance: {CurrentDistance} - {(Done() ? "Done" : "Executing")}";
        }
    }
}