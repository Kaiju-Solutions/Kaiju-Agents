...
namespace KaijuSolutions.Agents.Movement
{
    ...
    public abstract class KaijuTargetMovement : KaijuMovement
    {
        ...
        /// </summary>
        /// <param name="agent">The agent this is assigned to.</param>
        /// <param name="target">The transform to move in relation to.</param>
        /// <param name="distance">The distance to consider this move done.</param>
        ...
        /// </summary>
        /// <param name="agent">The agent this is assigned to.</param>
        /// <param name="target">The GameObject to move in relation to.</param>
        /// <param name="distance">The distance to consider this move done.</param>
        ...
        {
            Vector2? t = Target;
            return $"Kaiju Target Movement - Agent: {(Agent ? Agent.name : "None")} - Target: {(t.HasValue ? t.ToString() : "None")} - Distance: {Distance} - Current Distance: {CurrentDistance} - {(Done() ? "Done" : "Executing")}";
        }
