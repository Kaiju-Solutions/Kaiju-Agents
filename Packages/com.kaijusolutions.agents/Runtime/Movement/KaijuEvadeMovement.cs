...
namespace KaijuSolutions.Agents.Movement
{
    ...
    public class KaijuEvadeMovement : KaijuFleeMovement
    {
        ...
        /// </summary>
        /// <param name="agent">The agent this is assigned to.</param>
        /// <param name="target">The <see href="https://docs.unity3d.com/ScriptReference/Transform.html">transform</see> to evade from.</param>
        /// <param name="distance">The distance from the target to consider this movement done.</param>
        ...
        {
            Vector2? t = Target;
            return $"Kaiju Evade Movement - Agent: {(Agent ? Agent.name : "None")} - Target: {(t.HasValue ? t.ToString() : "None")} - Distance: {Distance} - Current Distance: {CurrentDistance} - Previous: {Previous} - {(Done() ? "Done" : "Executing")}";
        }
    }
}