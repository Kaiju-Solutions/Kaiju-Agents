...
{
    /// <summary>
    /// Actuator for controlling the movement of an <see cref="KaijuAgent"/> for <see href="https://docs.unity3d.com/Packages/com.unity.ml-agents@latest">ML-Agents</see>.
    /// </summary>
    [DisallowMultipleComponent]
#if UNITY_EDITOR
    [AddComponentMenu("Kaiju Solutions/Agents/ML-Agents/Actuators/Kaiju Learning Control Actuator", 6)]
    [Icon("Packages/ca.kaijusolutions.agents/Editor/Icon.png")]
    [HelpURL("https://agents.kaijusolutions.ca/manual/ml-agents.html")]
#endif
    public class KaijuLearningControlActuator : KaijuLearningAgentActuator
    {
        /// <summary>
        ...
        {
            Agent.Control = new(actionBuffers.ContinuousActions[0],  actionBuffers.ContinuousActions[1]);
        }
