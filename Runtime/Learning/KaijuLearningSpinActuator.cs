...
{
    /// <summary>
    /// Actuator for controlling the rotation of an <see cref="KaijuSolutions.Agents.KaijuAgent"/> via the <see cref="KaijuSolutions.Agents.KaijuAgent.Spin"/> property for <see href="https://docs.unity3d.com/Packages/com.unity.ml-agents@latest">ML-Agents</see>. This has one continuous action which is assigned to the <see cref="KaijuSolutions.Agents.KaijuAgent.Spin"/> property. This has no <see cref="Heuristic"/> implementation, and you will need to extend this class and override for your use case.
    /// </summary>
